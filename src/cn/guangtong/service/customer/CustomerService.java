package cn.guangtong.service.customer;
...
public interface CustomerService {
	 ...
	 * @return
	 */
	 List<Customer> getCustomersExcel(CustomerInfoPageBean pageBean);
	 ...
	 * @return
	 */
	Map<String, Object> getCustomersPie(String type, String name);
}
